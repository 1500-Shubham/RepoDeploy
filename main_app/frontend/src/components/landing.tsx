          ...
          <div className="space-y-4">
            ...
            <Button onClick={async () => {
              ...
              const interval = setInterval(async () => {
                ...
                // keep on asking 3000 is status is deployed 3 seconds interval pe
              }, 3000)
      ...
      {deployed && <Card className="w-full max-w-md mt-8">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Input id="deployed-url" readOnly type="url" value={`http://${uploadId}.shubham.com:3001/index.html`} />
          </div>
          <br />
          <Button className="w-full" variant="outline">
            <a href={`http://${uploadId}.shubham.com:3001/index.html`} target="_blank">
              Visit Website
            </a>
          </Button>
        </CardContent>
